...
fn test_one_node_hgf() {
    ...
    network.add_nodes("continuous-state", 1, None, None, None, None, None);
    // Node 1: value parent of node 0
    network.add_nodes("continuous-state", 1, None, Some(vec![0].into()), None, None, None);
...
fn test_two_nodes_hgf() {
    ...
    network.add_nodes("continuous-state", 1, None, Some(vec![0].into()), None, None, None);
    // Node 2: volatility parent of node 0
    network.add_nodes("continuous-state", 1, None, None, None, Some(vec![0].into()), None);
