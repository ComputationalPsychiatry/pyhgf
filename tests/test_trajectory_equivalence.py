...
ATOL = 1e-4  # tolerance for VDN vs node-level comparison
...
def _build_vdn():
    vdn = (
        ...
        .add_nodes(n_nodes=2, tonic_volatility=TONIC_VOL)
        .add_layer(size=4, tonic_volatility=TONIC_VOL)
        .add_layer(size=2, tonic_volatility=TONIC_VOL)
    )
